...
public class FrameworkTest implements GreenApp {
	...
	//Memory notes: (move to google doc sheet..)
	// # each input pipe must be 8MB to hold 16K requests based on 414 common request size
	// # need 512 input pipes to support minimal blocking so this is 4G of input buffer data
	// # for load we split 7 ways each with 3 tracks, 21 total trracks
	// # each track has 13*2(26) (546*8 - > 4.3G) same as above
	// # each track has 17MB pipe from router to reactor (17*21 -> .3G   (2x for json and db ->  .6G)
	// # each track has 34MB pipe from reactor to super (34*21 -> .6G    (2x for json and db -> 1.3G) -6.3 total
	// # output 546 * 4M -> 2G	// # big response 1.4K...  - 8.3 total..
	
	//add 404 lines
	//add socket buffers
	//add connection buffers
	//add db connection usage?
	
	//TODO: re-rlease everything?
    ...
    public FrameworkTest() {
    	...
    	//json ok with 2.7 G...  db ok with 3G 
    }   
