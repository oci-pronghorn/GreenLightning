...
public class ProcessUpdateNew {
	...
	public ProcessUpdateNew(int pipelineBits, HTTPResponseService service, PoolManager pm) {
...
//					worldObject.setStatus(500);
	...
	private void execUpdate(final PgConnection con, final PgPreparedQuery pu, final List<ResultObject> toUpdate,
		...
		//do as seprate long running connection.
		
		//prep the batch ... since this a new connection we keep doing it??
